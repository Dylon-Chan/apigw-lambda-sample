resource "aws_api_gateway_rest_api" "example_api" {     #create api gateway
  name = "${var.your_name}-lambda-api"
}
resource "aws_api_gateway_resource" "example_resource" {    #create a path /hello
  rest_api_id = aws_api_gateway_rest_api.example_api.id
  parent_id   = aws_api_gateway_rest_api.example_api.root_resource_id
  path_part  = "hello"
}
resource "aws_api_gateway_method" "example_method" {    #create a method called GET
  rest_api_id   = aws_api_gateway_rest_api.example_api.id
